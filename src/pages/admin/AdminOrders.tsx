...
export default function AdminOrders() {
    const { orders, partners, updateOrderStatus, assignPartner, currency } = useApp();
    ...
    const handleAssign = () => {
        ...
        assignPartner(assignModal, selectedPartner);
                                ...
                                orders.map((order: any) => (
                                    <tr key={order._id} className="hover:bg-zinc-50/50 transition-colors">
                                        <td className="px-6 py-4">
                                            <p className="font-semibold text-zinc-900">#{order._id.slice(-6).toUpperCase()}</p>
            ...
            {assignModal && (
                <>
                    ...
                    <div className="fixed inset-0 z-50 flex-center p-4">
                        <div className="bg-white rounded-2xl p-6 w-full max-w-sm animate-fade-in border border-app-border">
