...
export default function AdminDashboard() {
    const { orders, products, partners, currency } = useApp();
    ...
    const cards = [
        { label: "Total Orders", value: totalOrders, icon: ShoppingBagIcon },
        { label: "Total Users", value: 3, icon: UsersIcon },
        { label: "Total Products", value: totalProducts, icon: PackageIcon },
        { label: "Out of Stock", value: outOfStock, icon: AlertTriangleIcon },
    ];
