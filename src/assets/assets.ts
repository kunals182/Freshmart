...
export const footerData = {
    ...
    contact: [
        { icon: MapPinIcon, text: "123 Green Valley Rd, Sector 4, HSR Layout, Bengaluru" },
        { icon: PhoneIcon, text: "+91 98765 43210" },
        { icon: MailIcon, text: "hello@freshmart.in" },
    ],
    ...
    recentOrders: [
        {
            shippingAddress: {
                label: "Home",
                address: "New Market Road, HSR Layout",
                city: "Bengaluru",
                state: "KA",
                zip: "560102",
                lat: 12.9141,
...
export const dummyDashboardOrdersData = [
    ...
    {
        shippingAddress: { label: "Home", address: "New Market Road, HSR Layout", city: "Bengaluru", state: "KA", zip: "560102", lat: 12.9141, lng: 77.6369 },
        liveLocation: { lat: 12.9141, lng: 77.6369, updatedAt: "2026-04-06T08:41:27.211Z" },
        _id: "69d366617ed7e54198d67dad",
...
export const dummyAddressData = [
    { label: "Home", address: "123 Main St, Indiranagar", city: "Bengaluru", state: "KA", zip: "560038", isDefault: true, lat: 12.9716, lng: 77.6412, _id: "69d3652df9a340288f1a0f8c" },
    { label: "Work", address: "456 Market St, Koramangala", city: "Bengaluru", state: "KA", zip: "560034", isDefault: false, lat: 12.9352, lng: 77.6244, _id: "69d3652df9a340288f1a0f8d" },
];
